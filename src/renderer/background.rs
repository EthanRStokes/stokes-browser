...
impl Element<'_> {
    ...
    pub(super) fn draw_table_row_backgrounds(&self, scene: &mut impl PaintScene) {
            ...
            .zip(rows.gutters.iter().skip(1))
        {
            ...
            if bg_color != AlphaColor::TRANSPARENT {
                // Fill the color
    ...
    fn draw_svg_bg_image(&self, scene: &mut impl PaintScene, idx: usize) {
        ...
        let x_ratio = (bg_size.width as f64 / svg_size.width() as f64) * self.scale_factor;
        let y_ratio = (bg_size.height as f64 / svg_size.height() as f64) * self.scale_factor;
    ...
    fn draw_raster_bg_image(&self, scene: &mut impl PaintScene, idx: usize) {
        ...
        let bg_pos_x = bg_pos.x * self.scale_factor;
        let bg_pos_y = bg_pos.y * self.scale_factor;
        let bg_size = bg_size * self.scale_factor;
