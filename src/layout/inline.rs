...
use taffy::{compute_leaf_layout, AvailableSpace, LayoutPartialTree, MaybeMath, MaybeResolve, NodeId, Position, ResolveOrZero, Size};
use crate::dom::Dom;
...
impl Dom {
    pub(crate) fn compute_inline_layout(
        ...
        let style = self.nodes[node_id].taffy_style.clone();
